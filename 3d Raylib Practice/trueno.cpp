...
truenoVehicleCreator::truenoVehicleCreator() {																											//Initializing exact trueno car, all of the models abd textures are here
	...
	Entity wheelFR{ "wheelFR", LoadModel("./assets/wheel/wheel.obj"), LoadTexture("./assets/wheel/texturealbedo.png"), Camera3D{}, Vector3{} };			//Entity constructor
	...
	Entity wheelRR{ "wheelRR", LoadModel("./assets/wheel/wheel.obj"), LoadTexture("./assets/wheel/texturealbedo.png"), Camera3D{}, Vector3{} };			//Entity constructor
	...
	vehicle.wheelRL.position = Vector3{ vehicle.position.x - 3.0f, vehicle.position.y, vehicle.position.z - 5.4f };										//Relative positioning of the wheel
	vehicle.wheelRR.position = Vector3{ vehicle.position.x + 3.5f, vehicle.position.y, vehicle.position.z - 5.4f };										//Relative positioning of the wheel
